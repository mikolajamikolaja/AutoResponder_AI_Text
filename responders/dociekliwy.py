...
def build_dociekliwy_section(
    ...
    if diagram_svg_html:
        # BOM UTF-8 na początku — przeglądarka rozpozna kodowanie niezależnie od MIME type
        diagram_svg_b64 = base64.b64encode(b"\xef\xbb\xbf" + diagram_svg_html.encode("utf-8")).decode(
            "ascii"
        )
        logger.info(
